...
const PlayerBody = () => {
	...
	return (
		<div className='relative app-wrapper flex gap-1 flex-col justify-start items-center px-2 pb-3 pt-2 w-full h-full bg-backgroundSecond rounded-xl overflow-hidden sm:max-h-[650px] max-w-sm'>
